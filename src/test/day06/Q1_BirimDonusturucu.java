//private sadece o class icinde ulasilabilir.
//staticlere sadece static yazanlar ulasabilir.
//void return type, yani bir sey döndürmeyecek yazdiracak
...
public class Q1_BirimDonusturucu {
    ...
    public static void main(String[] args) {
        ...
        donusturucu(birim,miktar);   //compile ederken 3,0 gibi yaz. 3.0 hata veriyor
        System.out.println("================");
        donusturucu("saat",65);
        donusturucu("mil",89);
