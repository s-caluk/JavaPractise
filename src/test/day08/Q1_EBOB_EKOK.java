            ...
            public static void main(String[] args) {
                ...
                for (int i = kucukSayi; i > 1 ; i--) {
                    ...
                    if (sayi1%i==0 && sayi2%i==0){
                        ...
                        flag++;
                        break;    //EBOB u bulunca devam etmesin. bütün ortak bölenlerine ihtiyacimiz yok.
                    }
                }

                if (flag==0) System.out.println("Bu sayilarin EBOB'u yoktur");  //else görevi görüyor fakat flag kullanmaya alis



                for (int i = buyukSayi; i <= sayi1*sayi2 ; i+=buyukSayi) {  //büyük sayinin katlari seklinde gitsin
